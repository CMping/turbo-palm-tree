/**
 * User view post job page Action class: Once invoked lets user to go view own profile page
 * 
...
public class ViewPostJob extends ActionSupport implements SessionAware{
