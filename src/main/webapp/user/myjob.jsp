...
<td><a href="adminUpdateProfile.action?submitType=fetchProfile&jobID=<s:property value="jobID"/>">
<button class="button-update">Update</button></a>
<a href="adminDeleteProfile.action?submitType=fetchProfile&jobID=<s:property value="jobID"/>">
